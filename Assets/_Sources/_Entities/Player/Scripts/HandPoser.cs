...
public class HandPoser : MonoBehaviour
{
    ...
    private ChestHoverState _chestHoverState;
    private ButtonHoverState _buttonHoverState;
    private MainCharacterHoverState _mainCharacterHoverState;
    private RegularCharacterHoverState _regularCharacterHoverState;
    
    //GrabStateMachine
    // private GrabStateMachine _grabStateMachine;
    // private SelectMainCharacterGrabState _selectMainCharacterGrabState;
    // private DragItemGrabState _dragItemGrabState;
    // private EmptyGrabState _emptyGrabState;
    // private NoPressGrabState _noPressGrabState;
    ...
    // public LayerMask NoInteractable;
    // public XRDirectInteractor DirectInteractor;
    // public LayerMask AllInteractable;
    // public LayerMask MainCharacters;
    // public LayerMask Chests;
    // public GrabStateEnum GrabState;

    public Action<Character> OnMainCharacterHover;
    public Action OnMainCharacterDeHover;
    ...
    private void Awake()
    {
        ...
        _chestHoverState = new ChestHoverState(this);
        _buttonHoverState = new ButtonHoverState(this);
        _mainCharacterHoverState = new MainCharacterHoverState(this);
        _regularCharacterHoverState = new RegularCharacterHoverState(this);
        
        //GrabStateMachine initialization
        // _grabStateMachine = new GrabStateMachine();
        // _selectMainCharacterGrabState = new SelectMainCharacterGrabState(this);
        // _dragItemGrabState = new DragItemGrabState(this);
        // _emptyGrabState = new EmptyGrabState(this);
        // _noPressGrabState = new NoPressGrabState(this);
    ...
    private void Start()
    {
        ...
        // HoverDetectMask = AllInteractable;
    ...
    {
        RaycastHit[] hoverHitsInfo = Physics.SphereCastAll(_sphereCastPoint.position, 1.2f, transform.up, 0, HoverDetectMask, QueryTriggerInteraction.UseGlobal);
    ...
    private GameObject GetNearestInteractableObjects(RaycastHit[] hoverHitsInfo, out GameObject nearestChest)
    {
        ...
        for (int i = 0; i < hoverHitsInfo.Length; i++)
        {
            ...
            if (currentDistance < nearestDistance || nearestDistance == 0)
            {
                ...
                if (nearestObject.TryGetComponent(out Chest chest))
                {
                    nearestChest = chest.gameObject;
                }

                if (nearestObject.TryGetComponent(out Scroll scroll))
                {
                    nearestChest = scroll.Chest.gameObject;
                }
            }
        }
    ...
    private void OnDrawGizmos()
    {
        ...
        Gizmos.DrawWireSphere(_sphereCastPoint.position, 1.2f);
        
        Gizmos.color = Color.black;
        Gizmos.DrawSphere(_sphereCastPoint.position, 0.1f);
    }
    ...
    private HandHoverState GetHandHoverStateFromEnum(HandHoverStateEnum handHoverState)
    {
        ...
        switch (handHoverState)
        {
            ...
            case HandHoverStateEnum.StuffHover :
                ...
                break;
            case HandHoverStateEnum.ChestHover :
                state = _chestHoverState;
                break;
            case HandHoverStateEnum.ButtonHover :
                state = _buttonHoverState;
                break;
            case HandHoverStateEnum.MainCharacterHover :
                state = _mainCharacterHoverState;
                break;
            case HandHoverStateEnum.RegularCharacterHover :
                state = _regularCharacterHoverState;
                break;
        }
