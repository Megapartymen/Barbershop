    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            void geom(triangle v2f IN[3], inout TriangleStream<v2f> tristream)
            {
                ...
                float finalDensity =  minRelativeDensity;
                ...
                for (i = 0; i < 3; i++)
                {
                    ...
                    o.relativeDensity = finalDensity;
                    tristream.Append(o);
                }
            ...
            {
                // Pack the density so that 0.001 -> 0, 1 -> 0.5, 1000 -> 1
                float relativeDensity = saturate((log10(i.relativeDensity) + 4) * 0.125);
